...
public class NotificationtemplateModelImpl extends BaseModelImpl<Notificationtemplate>
	...
	public static final String TABLE_SQL_CREATE = "create table opencps_notificationtemplate (notificationTemplateId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,notificationType VARCHAR(75) null,emailSubject VARCHAR(75) null,emailBody VARCHAR(75) null,textMessage VARCHAR(75) null,sendSMS BOOLEAN,sendEmail BOOLEAN,expireDuration INTEGER,userUrlPattern VARCHAR(75) null,guestUrlPattern VARCHAR(75) null,interval_ VARCHAR(75) null,grouping BOOLEAN)";
	...
	public Object clone() {
		...
		notificationtemplateImpl.setSendSMS(getSendSMS());
		notificationtemplateImpl.setSendEmail(getSendEmail());
		...
		notificationtemplateImpl.setGrouping(getGrouping());
	...
	public CacheModel<Notificationtemplate> toCacheModel() {
		...
		notificationtemplateCacheModel.sendSMS = getSendSMS();

		notificationtemplateCacheModel.sendEmail = getSendEmail();
		...
		notificationtemplateCacheModel.grouping = getGrouping();
