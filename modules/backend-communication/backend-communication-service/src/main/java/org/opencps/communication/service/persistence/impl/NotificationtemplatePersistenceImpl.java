...
public class NotificationtemplatePersistenceImpl extends BasePersistenceImpl<Notificationtemplate>
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((notificationtemplate.getGroupId() != groupId) ||
							(notificationtemplate.getNotificationType() == null) ||
							!notificationtemplate.getNotificationType()
													 .equals(notificationType)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_F_NOTIFICATIONTEMPLATEBYTYPE,
							finderArgs, notificationtemplate);
					}
				}
			}
			catch (Exception e) {
	...
	public List<Notificationtemplate> findByF_NotificationtemplateEmailSubject(
		...
		if (list == null) {
			...
			else if (emailSubject.equals(StringPool.BLANK)) {
	...
	protected Notificationtemplate removeImpl(
		...
		notificationtemplate = toUnwrappedModel(notificationtemplate);
	...
	public Notificationtemplate updateImpl(
		...
		if (isNew || !NotificationtemplateModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
	...
	protected Notificationtemplate toUnwrappedModel(
		Notificationtemplate notificationtemplate) {
		if (notificationtemplate instanceof NotificationtemplateImpl) {
			return notificationtemplate;
		}

		NotificationtemplateImpl notificationtemplateImpl = new NotificationtemplateImpl();

		notificationtemplateImpl.setNew(notificationtemplate.isNew());
		notificationtemplateImpl.setPrimaryKey(notificationtemplate.getPrimaryKey());

		notificationtemplateImpl.setNotificationTemplateId(notificationtemplate.getNotificationTemplateId());
		notificationtemplateImpl.setGroupId(notificationtemplate.getGroupId());
		notificationtemplateImpl.setCompanyId(notificationtemplate.getCompanyId());
		notificationtemplateImpl.setUserId(notificationtemplate.getUserId());
		notificationtemplateImpl.setUserName(notificationtemplate.getUserName());
		notificationtemplateImpl.setCreateDate(notificationtemplate.getCreateDate());
		notificationtemplateImpl.setModifiedDate(notificationtemplate.getModifiedDate());
		notificationtemplateImpl.setNotificationType(notificationtemplate.getNotificationType());
		notificationtemplateImpl.setEmailSubject(notificationtemplate.getEmailSubject());
		notificationtemplateImpl.setEmailBody(notificationtemplate.getEmailBody());
		notificationtemplateImpl.setTextMessage(notificationtemplate.getTextMessage());
		notificationtemplateImpl.setSendSMS(notificationtemplate.isSendSMS());
		notificationtemplateImpl.setSendEmail(notificationtemplate.isSendEmail());
		notificationtemplateImpl.setExpireDuration(notificationtemplate.getExpireDuration());
		notificationtemplateImpl.setUserUrlPattern(notificationtemplate.getUserUrlPattern());
		notificationtemplateImpl.setGuestUrlPattern(notificationtemplate.getGuestUrlPattern());
		notificationtemplateImpl.setInterval(notificationtemplate.getInterval());
		notificationtemplateImpl.setGrouping(notificationtemplate.isGrouping());
