...
public class NotificationQueueCacheModel implements CacheModel<NotificationQueue>,
	...
	public NotificationQueue toEntityModel() {
		...
		if (userName == null) {
			notificationQueueImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (notificationType == null) {
			notificationQueueImpl.setNotificationType(StringPool.BLANK);
		}
		else {
		...
		if (className == null) {
			notificationQueueImpl.setClassName(StringPool.BLANK);
		}
		else {
		...
		if (classPK == null) {
			notificationQueueImpl.setClassPK(StringPool.BLANK);
		}
		else {
		...
		if (payload == null) {
			notificationQueueImpl.setPayload(StringPool.BLANK);
		}
		else {
		...
		if (fromUsername == null) {
			notificationQueueImpl.setFromUsername(StringPool.BLANK);
		}
		else {
		...
		if (toUsername == null) {
			notificationQueueImpl.setToUsername(StringPool.BLANK);
		}
		else {
		...
		if (toEmail == null) {
			notificationQueueImpl.setToEmail(StringPool.BLANK);
		}
		else {
		...
		if (toTelNo == null) {
			notificationQueueImpl.setToTelNo(StringPool.BLANK);
		}
		else {
