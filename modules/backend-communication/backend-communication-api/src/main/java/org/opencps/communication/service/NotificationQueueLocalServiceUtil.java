...
public class NotificationQueueLocalServiceUtil {
	...
	*/
	...
	public static org.opencps.communication.model.NotificationQueue addNotificationQueue(
		...
		java.lang.String payload, java.lang.String fromUsername,
		java.lang.String toUsername, long toUserId, java.lang.String toEmail,
		java.lang.String toTelNo, java.util.Date publicationDate,
	...
	*/
	...
	private static ServiceTracker<NotificationQueueLocalService, NotificationQueueLocalService> _serviceTracker =
		ServiceTrackerFactory.open(NotificationQueueLocalService.class);
}