...
public interface ServerConfigLocalService extends BaseLocalService,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ServerConfig> getByProtocol(long groupId,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ServerConfig getByCode(java.lang.String serverNo);
	...
	*/
	...
	public ServerConfig updateServerConfig(long groupId, long serverConfigId,
		java.lang.String serverNo, java.lang.String serverName,
		java.lang.String protocol, java.lang.String configs, Date lastSync,
		ServiceContext context) throws PortalException;
