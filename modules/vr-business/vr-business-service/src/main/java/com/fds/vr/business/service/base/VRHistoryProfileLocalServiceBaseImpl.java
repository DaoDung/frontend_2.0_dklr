...
import com.fds.vr.business.service.VRHistoryProfileLocalService;
...
/**
 * Provides the base implementation for the vr history profile local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRHistoryProfileLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRHistoryProfileLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRHistoryProfileLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRHistoryProfileLocalServiceUtil} to access the vr history profile local service.
	 */
	...
	public VRHistoryProfile addVRHistoryProfile(
		...
		return vrHistoryProfilePersistence.update(vrHistoryProfile);
	}
	...
	public VRHistoryProfile createVRHistoryProfile(long id) {
		return vrHistoryProfilePersistence.create(id);
	}
	...
	public VRHistoryProfile deleteVRHistoryProfile(long id)
		...
		return vrHistoryProfilePersistence.remove(id);
	}
	...
	public VRHistoryProfile deleteVRHistoryProfile(
		VRHistoryProfile vrHistoryProfile) {
		return vrHistoryProfilePersistence.remove(vrHistoryProfile);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRHistoryProfile.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrHistoryProfilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrHistoryProfilePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRHistoryProfile fetchVRHistoryProfile(long id) {
		return vrHistoryProfilePersistence.fetchByPrimaryKey(id);
	}
	...
	public VRHistoryProfile getVRHistoryProfile(long id)
		throws PortalException {
		return vrHistoryProfilePersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrHistoryProfileLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRHistoryProfile.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrHistoryProfileLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRHistoryProfile.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrHistoryProfileLocalService.deleteVRHistoryProfile((VRHistoryProfile)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrHistoryProfilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRHistoryProfile> getVRHistoryProfiles(int start, int end) {
		return vrHistoryProfilePersistence.findAll(start, end);
	}
	...
	public int getVRHistoryProfilesCount() {
		return vrHistoryProfilePersistence.countAll();
	}
	 ...
	 */
	public VRHistoryProfileLocalService getVRHistoryProfileLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRHistoryProfile",
			vrHistoryProfileLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRHistoryProfile");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRHistoryProfileLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrHistoryProfilePersistence.getDataSource();
	...
	@BeanReference(type = VRHistoryProfileLocalService.class)
	protected VRHistoryProfileLocalService vrHistoryProfileLocalService;
