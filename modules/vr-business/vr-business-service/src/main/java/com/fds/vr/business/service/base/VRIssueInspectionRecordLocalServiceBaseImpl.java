...
import com.fds.vr.business.service.VRIssueInspectionRecordLocalService;
...
/**
 * Provides the base implementation for the vr issue inspection record local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRIssueInspectionRecordLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRIssueInspectionRecordLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRIssueInspectionRecordLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRIssueInspectionRecordLocalServiceUtil} to access the vr issue inspection record local service.
	 */
	...
	@Override
	public VRIssueInspectionRecord addVRIssueInspectionRecord(
		VRIssueInspectionRecord vrIssueInspectionRecord) {
		vrIssueInspectionRecord.setNew(true);

		return vrIssueInspectionRecordPersistence.update(vrIssueInspectionRecord);
	}
	 ...
	 */
	@Override
	public VRIssueInspectionRecord createVRIssueInspectionRecord(long id) {
		return vrIssueInspectionRecordPersistence.create(id);
	}
	...
	@Override
	public VRIssueInspectionRecord deleteVRIssueInspectionRecord(long id)
		throws PortalException {
		return vrIssueInspectionRecordPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRIssueInspectionRecord deleteVRIssueInspectionRecord(
		VRIssueInspectionRecord vrIssueInspectionRecord) {
		return vrIssueInspectionRecordPersistence.remove(vrIssueInspectionRecord);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRIssueInspectionRecord.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrIssueInspectionRecordPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrIssueInspectionRecordPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRIssueInspectionRecord fetchVRIssueInspectionRecord(long id) {
		return vrIssueInspectionRecordPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRIssueInspectionRecord getVRIssueInspectionRecord(long id)
		throws PortalException {
		return vrIssueInspectionRecordPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrIssueInspectionRecordLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRIssueInspectionRecord.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrIssueInspectionRecordLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRIssueInspectionRecord.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrIssueInspectionRecordLocalService.deleteVRIssueInspectionRecord((VRIssueInspectionRecord)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrIssueInspectionRecordPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRIssueInspectionRecord> getVRIssueInspectionRecords(
		int start, int end) {
		return vrIssueInspectionRecordPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVRIssueInspectionRecordsCount() {
		return vrIssueInspectionRecordPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRIssueInspectionRecord updateVRIssueInspectionRecord(
		VRIssueInspectionRecord vrIssueInspectionRecord) {
		return vrIssueInspectionRecordPersistence.update(vrIssueInspectionRecord);
	}
	 ...
	 */
	public VRIssueInspectionRecordLocalService getVRIssueInspectionRecordLocalService() {
	...
	public void setVRIssueInspectionRecordLocalService(
		VRIssueInspectionRecordLocalService vrIssueInspectionRecordLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRIssueInspectionRecord",
			vrIssueInspectionRecordLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRIssueInspectionRecord");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRIssueInspectionRecordLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrIssueInspectionRecordPersistence.getDataSource();
	...
	@BeanReference(type = VRIssueInspectionRecordLocalService.class)
	protected VRIssueInspectionRecordLocalService vrIssueInspectionRecordLocalService;
