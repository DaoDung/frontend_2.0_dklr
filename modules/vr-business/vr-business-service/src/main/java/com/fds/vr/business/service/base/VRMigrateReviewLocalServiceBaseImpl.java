...
import com.fds.vr.business.service.VRMigrateReviewLocalService;
...
/**
 * Provides the base implementation for the vr migrate review local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRMigrateReviewLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRMigrateReviewLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRMigrateReviewLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRMigrateReviewLocalServiceUtil} to access the vr migrate review local service.
	 */
	...
	@Override
	public VRMigrateReview addVRMigrateReview(VRMigrateReview vrMigrateReview) {
		vrMigrateReview.setNew(true);

		return vrMigrateReviewPersistence.update(vrMigrateReview);
	}
	 ...
	 */
	@Override
	public VRMigrateReview createVRMigrateReview(long id) {
		return vrMigrateReviewPersistence.create(id);
	}
	...
	@Override
	public VRMigrateReview deleteVRMigrateReview(long id)
		throws PortalException {
		return vrMigrateReviewPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRMigrateReview deleteVRMigrateReview(
		VRMigrateReview vrMigrateReview) {
		return vrMigrateReviewPersistence.remove(vrMigrateReview);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRMigrateReview.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrMigrateReviewPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrMigrateReviewPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRMigrateReview fetchVRMigrateReview(long id) {
		return vrMigrateReviewPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRMigrateReview getVRMigrateReview(long id)
		throws PortalException {
		return vrMigrateReviewPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrMigrateReviewLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRMigrateReview.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrMigrateReviewLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRMigrateReview.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrMigrateReviewLocalService.deleteVRMigrateReview((VRMigrateReview)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrMigrateReviewPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRMigrateReview> getVRMigrateReviews(int start, int end) {
		return vrMigrateReviewPersistence.findAll(start, end);
	}
	...
	public int getVRMigrateReviewsCount() {
		return vrMigrateReviewPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRMigrateReview updateVRMigrateReview(
		VRMigrateReview vrMigrateReview) {
		return vrMigrateReviewPersistence.update(vrMigrateReview);
	}
	 ...
	 */
	public VRMigrateReviewLocalService getVRMigrateReviewLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRMigrateReview",
			vrMigrateReviewLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRMigrateReview");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRMigrateReviewLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrMigrateReviewPersistence.getDataSource();
	...
	@BeanReference(type = VRMigrateReviewLocalService.class)
	protected VRMigrateReviewLocalService vrMigrateReviewLocalService;
