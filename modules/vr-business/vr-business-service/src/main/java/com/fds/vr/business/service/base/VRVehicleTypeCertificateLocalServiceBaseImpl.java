...
import com.fds.vr.business.service.VRVehicleTypeCertificateLocalService;
...
/**
 * Provides the base implementation for the vr vehicle type certificate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRVehicleTypeCertificateLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRVehicleTypeCertificateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRVehicleTypeCertificateLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRVehicleTypeCertificateLocalServiceUtil} to access the vr vehicle type certificate local service.
	 */
	...
	public VRVehicleTypeCertificate createVRVehicleTypeCertificate(long id) {
		return vrVehicleTypeCertificatePersistence.create(id);
	}
	...
	public VRVehicleTypeCertificate deleteVRVehicleTypeCertificate(long id)
		...
		return vrVehicleTypeCertificatePersistence.remove(id);
	}
	...
	public VRVehicleTypeCertificate deleteVRVehicleTypeCertificate(
		VRVehicleTypeCertificate vrVehicleTypeCertificate) {
		return vrVehicleTypeCertificatePersistence.remove(vrVehicleTypeCertificate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRVehicleTypeCertificate.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrVehicleTypeCertificatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrVehicleTypeCertificatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRVehicleTypeCertificate fetchVRVehicleTypeCertificate(long id) {
		return vrVehicleTypeCertificatePersistence.fetchByPrimaryKey(id);
	}
	...
	public VRVehicleTypeCertificate getVRVehicleTypeCertificate(long id)
		throws PortalException {
		return vrVehicleTypeCertificatePersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrVehicleTypeCertificateLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRVehicleTypeCertificate.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrVehicleTypeCertificateLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRVehicleTypeCertificate.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrVehicleTypeCertificateLocalService.deleteVRVehicleTypeCertificate((VRVehicleTypeCertificate)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrVehicleTypeCertificatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRVehicleTypeCertificate> getVRVehicleTypeCertificates(
		int start, int end) {
		return vrVehicleTypeCertificatePersistence.findAll(start, end);
	}
	...
	public int getVRVehicleTypeCertificatesCount() {
		return vrVehicleTypeCertificatePersistence.countAll();
	}
	 ...
	 */
	public VRVehicleTypeCertificateLocalService getVRVehicleTypeCertificateLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRVehicleTypeCertificate",
			vrVehicleTypeCertificateLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRVehicleTypeCertificate");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRVehicleTypeCertificateLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrVehicleTypeCertificatePersistence.getDataSource();
	...
	@BeanReference(type = VRVehicleTypeCertificateLocalService.class)
	protected VRVehicleTypeCertificateLocalService vrVehicleTypeCertificateLocalService;
