...
import com.fds.vr.business.service.VRExpireCertificateLocalService;
...
/**
 * Provides the base implementation for the vr expire certificate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRExpireCertificateLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRExpireCertificateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRExpireCertificateLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRExpireCertificateLocalServiceUtil} to access the vr expire certificate local service.
	 */
	...
	public VRExpireCertificate addVRExpireCertificate(
		...
		return vrExpireCertificatePersistence.update(vrExpireCertificate);
	}
	...
	public VRExpireCertificate createVRExpireCertificate(long id) {
		return vrExpireCertificatePersistence.create(id);
	}
	...
	public VRExpireCertificate deleteVRExpireCertificate(long id)
		...
		return vrExpireCertificatePersistence.remove(id);
	}
	...
	public VRExpireCertificate deleteVRExpireCertificate(
		VRExpireCertificate vrExpireCertificate) {
		return vrExpireCertificatePersistence.remove(vrExpireCertificate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRExpireCertificate.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrExpireCertificatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrExpireCertificatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRExpireCertificate fetchVRExpireCertificate(long id) {
		return vrExpireCertificatePersistence.fetchByPrimaryKey(id);
	}
	...
	public VRExpireCertificate getVRExpireCertificate(long id)
		throws PortalException {
		return vrExpireCertificatePersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrExpireCertificateLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRExpireCertificate.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrExpireCertificateLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRExpireCertificate.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrExpireCertificateLocalService.deleteVRExpireCertificate((VRExpireCertificate)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrExpireCertificatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRExpireCertificate> getVRExpireCertificates(int start, int end) {
		return vrExpireCertificatePersistence.findAll(start, end);
	}
	...
	public int getVRExpireCertificatesCount() {
		return vrExpireCertificatePersistence.countAll();
	}
	 ...
	 */
	public VRExpireCertificateLocalService getVRExpireCertificateLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRExpireCertificate",
			vrExpireCertificateLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRExpireCertificate");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRExpireCertificateLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrExpireCertificatePersistence.getDataSource();
	...
	@BeanReference(type = VRExpireCertificateLocalService.class)
	protected VRExpireCertificateLocalService vrExpireCertificateLocalService;
