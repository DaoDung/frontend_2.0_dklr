...
import com.fds.vr.business.service.VRTrackchangesLocalService;
...
/**
 * Provides the base implementation for the vr trackchanges local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRTrackchangesLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRTrackchangesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRTrackchangesLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRTrackchangesLocalServiceUtil} to access the vr trackchanges local service.
	 */
	...
	public VRTrackchanges addVRTrackchanges(VRTrackchanges vrTrackchanges) {
		...
		return vrTrackchangesPersistence.update(vrTrackchanges);
	}
	...
	public VRTrackchanges createVRTrackchanges(long id) {
		return vrTrackchangesPersistence.create(id);
	}
	...
	public VRTrackchanges deleteVRTrackchanges(long id)
		...
		return vrTrackchangesPersistence.remove(id);
	}
	...
	public VRTrackchanges deleteVRTrackchanges(VRTrackchanges vrTrackchanges) {
		return vrTrackchangesPersistence.remove(vrTrackchanges);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRTrackchanges.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrTrackchangesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrTrackchangesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRTrackchanges fetchVRTrackchanges(long id) {
		return vrTrackchangesPersistence.fetchByPrimaryKey(id);
	}
	...
	public VRTrackchanges getVRTrackchanges(long id) throws PortalException {
		return vrTrackchangesPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrTrackchangesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRTrackchanges.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrTrackchangesLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRTrackchanges.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrTrackchangesLocalService.deleteVRTrackchanges((VRTrackchanges)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrTrackchangesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRTrackchanges> getVRTrackchangeses(int start, int end) {
		return vrTrackchangesPersistence.findAll(start, end);
	}
	...
	public int getVRTrackchangesesCount() {
		return vrTrackchangesPersistence.countAll();
	}
	 ...
	 */
	public VRTrackchangesLocalService getVRTrackchangesLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRTrackchanges",
			vrTrackchangesLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRTrackchanges");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRTrackchangesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrTrackchangesPersistence.getDataSource();
	...
	@BeanReference(type = VRTrackchangesLocalService.class)
	protected VRTrackchangesLocalService vrTrackchangesLocalService;
