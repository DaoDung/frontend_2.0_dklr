...
import com.fds.vr.business.service.VRESLocalService;
...
/**
 * Provides the base implementation for the vres local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRESLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 * @see com.fds.vr.business.service.impl.VRESLocalServiceImpl
 * @see com.fds.vr.business.service.VRESLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class VRESLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements VRESLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRESLocalServiceUtil} to access the vres local service.
	 */
	...
	@Override
	public VRES addVRES(VRES vres) {
		vres.setNew(true);

		return vresPersistence.update(vres);
	}
	 ...
	 */
	@Override
	public VRES createVRES(long id) {
		return vresPersistence.create(id);
	}
	...
	@Override
	public VRES deleteVRES(long id) throws PortalException {
		return vresPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRES deleteVRES(VRES vres) {
		return vresPersistence.remove(vres);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRES.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vresPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return vresPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vresPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return vresPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public VRES fetchVRES(long id) {
		return vresPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRES getVRES(long id) throws PortalException {
		return vresPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vresLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRES.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vresLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRES.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vresLocalService.deleteVRES((VRES)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vresPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRES> getVRESs(int start, int end) {
		return vresPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVRESsCount() {
		return vresPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRES updateVRES(VRES vres) {
		return vresPersistence.update(vres);
	}
	 ...
	 */
	public VRESLocalService getVRESLocalService() {
	 ...
	 */
	public void setVRESLocalService(VRESLocalService vresLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRES",
			vresLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRES");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRESLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vresPersistence.getDataSource();
	...
	@BeanReference(type = VRESLocalService.class)
	protected VRESLocalService vresLocalService;
