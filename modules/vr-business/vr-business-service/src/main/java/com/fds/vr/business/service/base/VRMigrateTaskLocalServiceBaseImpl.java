...
import com.fds.vr.business.service.VRMigrateTaskLocalService;
...
/**
 * Provides the base implementation for the vr migrate task local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRMigrateTaskLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRMigrateTaskLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRMigrateTaskLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRMigrateTaskLocalServiceUtil} to access the vr migrate task local service.
	 */
	...
	public VRMigrateTask addVRMigrateTask(VRMigrateTask vrMigrateTask) {
		...
		return vrMigrateTaskPersistence.update(vrMigrateTask);
	}
	...
	public VRMigrateTask createVRMigrateTask(long task_id) {
		return vrMigrateTaskPersistence.create(task_id);
	}
	...
	public VRMigrateTask deleteVRMigrateTask(long task_id)
		...
		return vrMigrateTaskPersistence.remove(task_id);
	}
	...
	public VRMigrateTask deleteVRMigrateTask(VRMigrateTask vrMigrateTask) {
		return vrMigrateTaskPersistence.remove(vrMigrateTask);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRMigrateTask.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrMigrateTaskPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrMigrateTaskPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRMigrateTask fetchVRMigrateTask(long task_id) {
		return vrMigrateTaskPersistence.fetchByPrimaryKey(task_id);
	}
	...
	public VRMigrateTask getVRMigrateTask(long task_id)
		throws PortalException {
		return vrMigrateTaskPersistence.findByPrimaryKey(task_id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrMigrateTaskLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRMigrateTask.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("task_id");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrMigrateTaskLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRMigrateTask.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("task_id");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrMigrateTaskLocalService.deleteVRMigrateTask((VRMigrateTask)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrMigrateTaskPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public int getVRMigrateTasksCount() {
		return vrMigrateTaskPersistence.countAll();
	}
	 ...
	 */
	public VRMigrateTaskLocalService getVRMigrateTaskLocalService() {
	...
	public void setVRMigrateTaskLocalService(
		VRMigrateTaskLocalService vrMigrateTaskLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRMigrateTask",
			vrMigrateTaskLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRMigrateTask");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRMigrateTaskLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrMigrateTaskPersistence.getDataSource();
	...
	@BeanReference(type = VRMigrateTaskLocalService.class)
	protected VRMigrateTaskLocalService vrMigrateTaskLocalService;
