...
import com.fds.vr.business.service.VRMigrateMappingsLocalService;
...
/**
 * Provides the base implementation for the vr migrate mappings local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRMigrateMappingsLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 * @see com.fds.vr.business.service.impl.VRMigrateMappingsLocalServiceImpl
 * @see com.fds.vr.business.service.VRMigrateMappingsLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class VRMigrateMappingsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRMigrateMappingsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRMigrateMappingsLocalServiceUtil} to access the vr migrate mappings local service.
	 */

	/**
	 * Adds the vr migrate mappings to the database. Also notifies the appropriate model listeners.
	 *
	 * @param vrMigrateMappings the vr migrate mappings
	 * @return the vr migrate mappings that was added
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRMigrateMappings addVRMigrateMappings(
		VRMigrateMappings vrMigrateMappings) {
		vrMigrateMappings.setNew(true);

		return vrMigrateMappingsPersistence.update(vrMigrateMappings);
	}
	 ...
	 */
	@Override
	public VRMigrateMappings createVRMigrateMappings(long id) {
		return vrMigrateMappingsPersistence.create(id);
	}

	/**
	 * Deletes the vr migrate mappings with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param id the primary key of the vr migrate mappings
	 * @return the vr migrate mappings that was removed
	 * @throws PortalException if a vr migrate mappings with the primary key could not be found
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRMigrateMappings deleteVRMigrateMappings(long id)
		throws PortalException {
		return vrMigrateMappingsPersistence.remove(id);
	}

	/**
	 * Deletes the vr migrate mappings from the database. Also notifies the appropriate model listeners.
	 *
	 * @param vrMigrateMappings the vr migrate mappings
	 * @return the vr migrate mappings that was removed
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRMigrateMappings deleteVRMigrateMappings(
		VRMigrateMappings vrMigrateMappings) {
		return vrMigrateMappingsPersistence.remove(vrMigrateMappings);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRMigrateMappings.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrMigrateMappingsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrMigrateMappingsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRMigrateMappings fetchVRMigrateMappings(long id) {
		return vrMigrateMappingsPersistence.fetchByPrimaryKey(id);
	}

	/**
	 * Returns the vr migrate mappings with the primary key.
	 *
	 * @param id the primary key of the vr migrate mappings
	 ...
	 */
	@Override
	public VRMigrateMappings getVRMigrateMappings(long id)
		throws PortalException {
		return vrMigrateMappingsPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrMigrateMappingsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRMigrateMappings.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrMigrateMappingsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRMigrateMappings.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrMigrateMappingsLocalService.deleteVRMigrateMappings((VRMigrateMappings)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrMigrateMappingsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRMigrateMappings> getVRMigrateMappingses(int start, int end) {
		return vrMigrateMappingsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVRMigrateMappingsesCount() {
		return vrMigrateMappingsPersistence.countAll();
	}

	/**
	 * Updates the vr migrate mappings in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param vrMigrateMappings the vr migrate mappings
	 * @return the vr migrate mappings that was updated
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRMigrateMappings updateVRMigrateMappings(
		VRMigrateMappings vrMigrateMappings) {
		return vrMigrateMappingsPersistence.update(vrMigrateMappings);
	}
	 ...
	 */
	public VRMigrateMappingsLocalService getVRMigrateMappingsLocalService() {
	...
	public void setVRMigrateMappingsLocalService(
		VRMigrateMappingsLocalService vrMigrateMappingsLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRMigrateMappings",
			vrMigrateMappingsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRMigrateMappings");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRMigrateMappingsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrMigrateMappingsPersistence.getDataSource();
	...
	@BeanReference(type = VRMigrateMappingsLocalService.class)
	protected VRMigrateMappingsLocalService vrMigrateMappingsLocalService;
