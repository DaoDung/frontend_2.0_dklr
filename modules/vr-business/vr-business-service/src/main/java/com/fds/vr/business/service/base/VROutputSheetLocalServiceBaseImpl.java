...
import com.fds.vr.business.service.VROutputSheetLocalService;
...
/**
 * Provides the base implementation for the vr output sheet local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VROutputSheetLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VROutputSheetLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VROutputSheetLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VROutputSheetLocalServiceUtil} to access the vr output sheet local service.
	 */
	...
	public VROutputSheet createVROutputSheet(long id) {
		return vrOutputSheetPersistence.create(id);
	}
	...
	public VROutputSheet deleteVROutputSheet(long id) throws PortalException {
		return vrOutputSheetPersistence.remove(id);
	}
	...
	public VROutputSheet deleteVROutputSheet(VROutputSheet vrOutputSheet) {
		return vrOutputSheetPersistence.remove(vrOutputSheet);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VROutputSheet.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrOutputSheetPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrOutputSheetPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VROutputSheet fetchVROutputSheet(long id) {
		return vrOutputSheetPersistence.fetchByPrimaryKey(id);
	}
	...
	public VROutputSheet getVROutputSheet(long id) throws PortalException {
		return vrOutputSheetPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrOutputSheetLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VROutputSheet.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrOutputSheetLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VROutputSheet.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrOutputSheetLocalService.deleteVROutputSheet((VROutputSheet)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrOutputSheetPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VROutputSheet> getVROutputSheets(int start, int end) {
		return vrOutputSheetPersistence.findAll(start, end);
	}
	...
	public int getVROutputSheetsCount() {
		return vrOutputSheetPersistence.countAll();
	}
	 ...
	 */
	public VROutputSheetLocalService getVROutputSheetLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VROutputSheet",
			vrOutputSheetLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VROutputSheet");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VROutputSheetLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrOutputSheetPersistence.getDataSource();
	...
	@BeanReference(type = VROutputSheetLocalService.class)
	protected VROutputSheetLocalService vrOutputSheetLocalService;
