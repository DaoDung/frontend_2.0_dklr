...
import com.fds.vr.business.service.VRReportCategoryLocalService;
...
/**
 * Provides the base implementation for the vr report category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRReportCategoryLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRReportCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRReportCategoryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRReportCategoryLocalServiceUtil} to access the vr report category local service.
	 */
	...
	@Override
	public VRReportCategory addVRReportCategory(
		VRReportCategory vrReportCategory) {
		vrReportCategory.setNew(true);

		return vrReportCategoryPersistence.update(vrReportCategory);
	}
	 ...
	 */
	@Override
	public VRReportCategory createVRReportCategory(int id) {
		return vrReportCategoryPersistence.create(id);
	}
	...
	@Override
	public VRReportCategory deleteVRReportCategory(int id)
		throws PortalException {
		return vrReportCategoryPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRReportCategory deleteVRReportCategory(
		VRReportCategory vrReportCategory) {
		return vrReportCategoryPersistence.remove(vrReportCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRReportCategory.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrReportCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrReportCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRReportCategory fetchVRReportCategory(int id) {
		return vrReportCategoryPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRReportCategory getVRReportCategory(int id)
		throws PortalException {
		return vrReportCategoryPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrReportCategoryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRReportCategory.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrReportCategoryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRReportCategory.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrReportCategoryLocalService.deleteVRReportCategory((VRReportCategory)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrReportCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRReportCategory> getVRReportCategories(int start, int end) {
		return vrReportCategoryPersistence.findAll(start, end);
	}
	...
	public int getVRReportCategoriesCount() {
		return vrReportCategoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRReportCategory updateVRReportCategory(
		VRReportCategory vrReportCategory) {
		return vrReportCategoryPersistence.update(vrReportCategory);
	}
	 ...
	 */
	public VRReportCategoryLocalService getVRReportCategoryLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRReportCategory",
			vrReportCategoryLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRReportCategory");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRReportCategoryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrReportCategoryPersistence.getDataSource();
	...
	@BeanReference(type = VRReportCategoryLocalService.class)
	protected VRReportCategoryLocalService vrReportCategoryLocalService;
